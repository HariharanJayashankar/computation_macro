...
ddelta 			= .025;								% depreciation (quarterly)
rrhoProd 		= .859; 								% persistence of idiosyncratic shocks (quarterly)
ssigmaProd 	    = .015;								% SD innovations of idiosycnratic shocks (quarterly)
aaUpper 		= .011; 								% no fixed cost region upper bound
aaLower 		= -.011;								% no fixed cost region lower bound
ppsiCapital 	= .1							% upper bound on fixed adjustment cost draws
...
% Aggregate shocks
rrhoTFP			= 0.9797;							% persistence of aggregate TFP (annual)
ssigmaTFP		= .0080;								% SD of innovations of aggregate TFP (annual)
rrhoQ			= 0.9695;							% persistence of aggregate investment-specific shock (annual)
ssigmaQ		    = .006;								% SD of innovations of aggregate investment-specific shock (annual)
corrTFPQ		= -0.0043;									% loading on TFP shock in evolution of investment-specific shock
